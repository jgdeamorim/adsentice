      ...
      >
        ...
        {isAdmin && (
          ...
          >
            ...
            <MenuItem href={`/${locale}/admin/pipeline`}>
            ...
            <MenuItem href={`/${locale}/admin/criteria`}>
              <i className='ri-equalizer-line' style={{ marginRight: 8 }} />
              Critérios
            </MenuItem>
            <MenuItem href={`/${locale}/admin/solutions`}>
              <i className='ri-stack-line' style={{ marginRight: 8 }} />
              Soluções
            </MenuItem>
            <MenuItem href={`/${locale}/admin/market`}>
            ...
            <MenuItem href={`/${locale}/admin/settings/wa-check`}>
              <i className='ri-whatsapp-line' style={{ marginRight: 8 }} />
              Wa-Check
            </MenuItem>
