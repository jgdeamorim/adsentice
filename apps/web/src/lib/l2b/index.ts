...
export { extractStaff } from "./extractors/staff-extractor"
export type { StaffData, StaffMember } from "./extractors/staff-extractor"
export { extractInsurance } from "./extractors/insurance-extractor"
export type { InsuranceData } from "./extractors/insurance-extractor"
export { normalizeAll, toMinedContent, normalizePhones, normalizeEmails, normalizeServices, extractHandle, normalizeDoctors, normalizeInsurance } from "./extractors/normalizer"
