...
export const ICP_CATEGORIES = new Set([
  "dentist", "medical_aesthetic_clinic", "medical_clinic", "restaurant",
  "gym", "lawyer", "barber_shop", "pharmacy", "veterinarian",
...
export const ICP_CATEGORY_LABELS: Record<string, string> = {
  ...
  medical_clinic: "Clínica Médica", restaurant: "Restaurante",
  gym: "Academia", lawyer: "Advogado", barber_shop: "Barbearia",
  pharmacy: "Farmácia", veterinarian: "Veterinário",
