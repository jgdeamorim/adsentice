...
function seedRegistry() {
  const nodes: SemanticNode[] = [
    ...
    { id: "product.sentinela", type: "product", name: "Sentinela (R$197/mes)", description: "Monitoramento mensal + Cockpit TOP-K diario. SEO Local continuo.", intent: "monitorar saude digital mensalmente", props: { price: "R$197/mes", margin: "95%" }, edges: ["hub.cockpit", "hub.gmb", "hub.website", "hub.scoring", "product.raio-x", "product.dominio"], mutationId: 1, version: 1, tags: ["starter", "R$197", "produto"] },
