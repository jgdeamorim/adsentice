...
return null
    ...
    const listings = params.listings
      ...
      .map(l => ({
        ...
        cid: (l as any).cid ?? null,
        total_photos: (l as any).total_photos ?? null, description: (l as any).description ?? null,
        main_image: (l as any).main_image ?? null, rating_distribution: (l as any).rating_distribution ?? null,
        snippet: (l as any).snippet ?? null, check_url: (l as any).check_url ?? null,
        first_seen: (l as any).first_seen ?? null, last_updated_time: (l as any).last_updated_time ?? null,
        domain: (l as any).domain ?? null, people_also_search: (l as any).people_also_search ?? null,
        attributes: (l as any).attributes ?? null, logo: (l as any).logo ?? null,
        work_time: (l as any).work_time ?? null,
        additional_categories: (l as any).additional_categories ?? null,
        category_ids: (l as any).category_ids ?? null,
        contact_info: (l as any).contact_info ?? null,
        feature_id: (l as any).feature_id ?? null,
        hotel_rating: (l as any).hotel_rating ?? null,
        local_business_links: (l as any).local_business_links ?? null,
        original_title: (l as any).original_title ?? null,
        place_topics: (l as any).place_topics ?? null,
        popular_times: (l as any).popular_times ?? null,
        services: (l as any).services ?? null,
        source_type: (l as any).source_type ?? null,
